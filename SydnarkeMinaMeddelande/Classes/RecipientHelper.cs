...
namespace DigitalEmployment.Lekeberg
{
    public class RecipientHelper
    {
        ...
        public bool ValidRecipient(string recipient)
        {
            ...
            recipient = RemoveCharInRecipient(recipient);
            validRecipient = true;// ValidateRecipientPersonNo(recipient);
        ...
        private bool ValidateRecipientPersonNo(string recipient)
        {
            ...
            {
                return true;// return new Regex(ConfigHelper.ConfigurationEntity.RegexValidationPersonNo).IsMatch(recipient);
            }
            return false;
        }
        ...
        private bool ValidateRecipientOrganizationNo(string recipient)
        {
            ...
            if (IsValidCheckNumber(recipient))
            {
                ...
                return new Regex(ConfigHelper.ConfigurationEntity.RegexValidationOrganizationNo).IsMatch(recipient);
            }
            return false;
        }
