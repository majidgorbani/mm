...
namespace SE.GOV.MM.Integration.Package.Signing.Helper
{
    ...
    {              
        ...
        {
            LogManager.LogTrace(string.Format("SE.GOV.MM.Integration.Package.BusinessLayer.Helper.SigningCertificateHelper: incoming call GetXMLSigningCertificate with RequestId: {0}", requestId));
            ...
            {
                var errorMessage = string.Format("SE.GOV.MM.Integration.Package.BusinessLayer.Helper.SigningCertificateHelper: No certificate found, sign xml. RequestId: {0}", requestId);
            ...
            LogManager.LogTrace(string.Format("SE.GOV.MM.Integration.Package.BusinessLayer.Helper.SigningCertificateHelper: leaving GetXMLSigningCertificate with RequestId: {0}", requestId));
            return certificate;
        }
    }
}
