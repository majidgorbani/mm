...
namespace SE.GOV.MM.Integration.DeliveryMailbox.Signing.Helper
{
    ...
    public class ValidateMailHelper
    {
        ...
        {
            LogManager.LogTrace(string.Format("SE.GOV.MM.Integration.DeliveryMailbox.BusinessLayer.Helper: incoming ValidateMailHelper Recipient with RequestId: {0}", requestId));
            ...
            LogManager.LogTrace(string.Format("SE.GOV.MM.Integration.DeliveryMailbox.BusinessLayer.Helper: leaving ValidateMailHelper Recipient with RequestId: {0}", requestId));
            return isOk;
        }
        ...
        {
            LogManager.LogTrace(string.Format("SE.GOV.MM.Integration.DeliveryMailbox.BusinessLayer.Helper: incoming ValidateMailHelper ScriptTag with RequestId: {0}", requestId));
            ...
            LogManager.LogTrace(string.Format("SE.GOV.MM.Integration.DeliveryMailbox.BusinessLayer.Helper: leaving ValidateMailHelper ScriptTag with RequestId: {0}", requestId));
        }
